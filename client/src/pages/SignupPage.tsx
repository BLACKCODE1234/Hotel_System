...
const SignupPage: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-lg bg-ink/40 border border-white/10 p-8 md:p-10 animate-rise">
        ...
        <p className="text-white mb-8">Join to manage bookings and guest preferences.</p>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs uppercase tracking-wider text-white font-semibold mb-2">First name</label>
            ...
            <div>
              <label className="block text-xs uppercase tracking-wider text-white font-semibold mb-2">Last name</label>
          ...
          <div>
            <label className="block text-xs uppercase tracking-wider text-white font-semibold mb-2">Phone</label>
          ...
          <div>
            <label className="block text-xs uppercase tracking-wider text-white font-semibold mb-2">Confirm password</label>
            <div className="relative">
              <input
